...
module my_nco_10m_st(clk, reset_n, clken, phi_inc_i, freq_mod_i, fsin_o, fcos_o, out_valid);
...
parameter mxnbc = 160;
parameter mxnbf = 160;
parameter rsfc = "my_nco_10m_sin_c.hex";
parameter rsff = "my_nco_10m_sin_f.hex";
parameter rcfc = "my_nco_10m_cos_c.hex";
parameter rcff = "my_nco_10m_cos_f.hex";
parameter nc = 1;
parameter pl = nc;
parameter log2nc =0;
