...
module my_nco_10m (
	...
	my_nco_10m_st	my_nco_10m_st_inst(
		.phi_inc_i(phi_inc_i),
		.clk(clk),
		.reset_n(reset_n),
		.clken(clken),
...
// Retrieval info:  <NETLIST_SECTION active_core="my_nco_10m_st" >
...
// Retrieval info:      <PRIVATE name = "APRI" value="8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="my_nco_10m_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="my_nco_10m_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="my_nco_10m_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="my_nco_10m_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="my_nco_10m_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="my_nco_10m_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="my_nco_10m_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="my_nco_10m_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="my_nco_10m_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="my_nco_10m_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="my_nco_10m_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="my_nco_10m_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="my_nco_10m_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="my_nco_10m_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="160"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="160"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWC" value="4"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWF" value="4"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWC" value="16"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWF" value="16"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="480"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="my_nco_10m.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="my_nco_10m_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: my_nco_10m_st.v, my_nco_10m.v;
// IPFS_FILES: my_nco_10m.vo;
// =========================================================
