...
if {[file exist "C:/Users/21503/Desktop/My_16QAM-main/my_nco_10m.mpf"] == 0} {
  project new [pwd] my_nco_10m
} else	{
project open my_nco_10m
}
...
vcom -93 my_nco_10m.vho
vcom -93 my_nco_10m_tb.vhd
vsim -novopt my_nco_10m_tb
do my_nco_10m_wave.do
run 22000 ns
