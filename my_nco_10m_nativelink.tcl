...
set ipfs_ext "vo"
if {[file exists my_nco_10m.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find my_nco_10m.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME my_nco_10m_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.my_nco_10m_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "my_nco_10m.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "my_nco_10m_tb.${hdl_ext}" -section_id tb -library work
